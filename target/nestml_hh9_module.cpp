...
nestml_hh9_module nestml_hh9_module_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

nestml_hh9_module::nestml_hh9_module()
{
#ifdef LINKED_MODULE
...
const std::string
nestml_hh9_module::name() const
{
  return std::string("nestml_hh9_module"); // Return name of the module
}

//-------------------------------------------------------------------------------------
void
nestml_hh9_module::init( SLIInterpreter* i )
{
    // register neurons
    nest::kernel().model_manager.register_node_model<hh_psc_alpha2_nestml>("hh_psc_alpha2_nestml");
} // nestml_hh9_module::init()
