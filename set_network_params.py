...
class neural_network():
    def __init__(self):
        ...
        self.rng_seed = np.random.randint(10**7) if args['seed'] is 0 else args['seed'] #set seed for NEST 	
        self.time_resolution = args['delta_clock'] 		#equivalent to "delta_clock"
        self.inh_pop_neurons = args['inh_inter_pop_size']
        self.rg_pop_neurons = args['rg_pop_size']
        self.num_exc_inter_tonic = round(args['exc_inter_pop_size']*args['exc_inter_pct_tonic'])
        self.num_exc_inter_bursting = args['exc_inter_pop_size']-self.num_exc_inter_tonic
        self.num_motor_neurons = args['mn_pop_size']
        self.num_exc_inter_pop = args ['exc_inter_pop_size']
        ...
        self.rg_exc_pop_count = round(self.exc_neurons_count*args['exc_pct_tonic'])
        ...
        self.gap_junction_conn = args['sparsity_gj']
        self.init_gap_weight = args['gap_weight']
        self.gap_connect_bursting = args['gap_connect_bursting']
        self.gap_connect_inh_inter = args['gap_connect_inh_inter']
        self.gap_connect_tonic = args['gap_connect_tonic']
        self.gap_connect_mnp = args['gap_connect_mnp']
        self.dopa_en = args['dopamine_enabled']
        self.dopamod_synapses = args['dopamod_synapses']
        self.phasic_dopa_peak = args['phasic_dopa_peak']
        self.tonic_dopa_rate = args['tonic_dopa_rate']
        self.dopa_thresh = args['dopa_sensitivity_threshold']
        self.dopa_alpha_d1 = args['dopamine_sensitivity_d1'] 
        self.dopa_alpha_d2 = args['dopamine_sensitivity_d2']         
        self.sim_time = args['sim_time']         #time in ms
        ...
        self.w_weak_exc_mean = 0.75*self.w_exc_mean #nS
        self.w_weak_exc_std = 0.75*self.w_exc_std #nS        
        ...
        self.I_e_bursting_mean = args['input_bias_bursting'] #pA Control = 160
        self.I_e_bursting_std = 0.25*self.I_e_bursting_mean #pA Control = 40
        self.I_e_tonic_mean = args['input_bias_tonic'] #pA Control = 320
        self.I_e_tonic_std = 0.25*self.I_e_tonic_mean #pA Control = 0		
        ...
        self.neuron_V_NaP_I_syn = args ['neuron_V_NaP_I_syn']
        ...
        self.conn_dict_custom_mn = {'rule': 'pairwise_bernoulli', 'p': args['sparsity_mn']}
        self.conn_dict_custom_gap = {'rule': 'symmetric_pairwise_bernoulli', 'p': args['sparsity_gj'],'allow_autapses': False, 'make_symmetric': True}
