...
def order_by_phase(convolved_activity, population_mean_activity, pop_name):
    ...
    freqs_pop, psd_pop = signal.welch(population_mean_activity,fs=10)
    ...
    for convolved_activity_neuron_i in convolved_activity:
        ...
        f, Pxy = signal.csd(convolved_activity_neuron_i,population_mean_activity,fs=10)
